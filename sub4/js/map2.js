 window.onload = function() {
    ...
    var options = {
        center: new daum.maps.LatLng(37.5558978,127.0052553),
        level: 2
    };
    ...
    var markerPosition  = new daum.maps.LatLng(37.5558978,127.0052553); 
    ...
    var options2 = {
        center: new daum.maps.LatLng(37.55711539018284, 127.00770161873821),
        level: 2
    };
    ...
    var markerPosition2  = new daum.maps.LatLng(37.55711539018284, 127.00770161873821); 
   ...
   var options3 = {
       center: new daum.maps.LatLng(37.57254369601293, 126.98114666922692),
       level: 2
   };
   ...
   var markerPosition3  = new daum.maps.LatLng(37.57254369601293, 126.98114666922692); 
